...
TARG=rbot
GOFILES=rbot.go handler.go auth.go cmd-access.go cmd-admin.go cmd-op.go cmd-google.go cmd-booru.go cmd-ap.go bitly.go cmd-help.go cmd-misc.go stream.go
